<template>
    <div class="AuthRecovery">
        <div class="AuthRecovery__head">
            {{ $t('auth.recoveryText') }}
        </div>
        <div class="AuthRecovery__body">
            <div class="AuthRecovery__body-item">
                <input class="AuthRecovery__body-item-input"
